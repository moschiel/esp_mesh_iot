...
void send_ws_ota_status(char* msg, bool done) {
    char payload[500];
    if(mount_msg_ota_status(payload, sizeof(payload), msg, done)) {
...
static void ota_task(void *arg) {
    ...
    send_ws_ota_status("Started OTA", false);
    ...
    if (esp_https_ota(&ota_config) == ESP_OK) 
    {
        ...
        send_ws_ota_status("OTA Succeed, Rebooting...", true);
    ...
    else 
    {
        ...
        send_ws_ota_status("OTA Failed", true);
    }
